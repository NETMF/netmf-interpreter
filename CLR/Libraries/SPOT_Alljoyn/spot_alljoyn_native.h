...
struct Library_spot_alljoyn_native_Microsoft_SPOT_AllJoyn_AJ
{
    ...
    TINYCLR_NATIVE_DECLARE(ClientConnectService___MicrosoftSPOTAllJoynAJStatus__U4__STRING__U4__U1__STRING__U2__BYREF_U4__MicrosoftSPOTAllJoynAJSessionOpts__BYREF_STRING);
