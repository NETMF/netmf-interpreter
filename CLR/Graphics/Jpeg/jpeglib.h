...
// tinyclr - We don't need stdio src / dest (so we can take out dependency on stdio.h)
//EXTERN(void) jpeg_stdio_dest JPP((j_compress_ptr cinfo, FILE * outfile));
//EXTERN(void) jpeg_stdio_src JPP((j_decompress_ptr cinfo, FILE * infile));

// tinyclr - Add our byte array source
EXTERN(void) jpeg_byte_array_src JPP((j_decompress_ptr cinfo, UINT8 * source, size_t size));
