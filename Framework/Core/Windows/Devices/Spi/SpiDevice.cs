...
namespace Windows.Devices.Spi
{
    public sealed class SpiDevice : IDisposable
    {
        ...
        private static readonly SpiBusInfo s_busInfo = new SpiBusInfo();
        ...
        internal SpiDevice(string deviceId, SpiConnectionSettings settings)
        {
            ...
            // Silence warnings about unused variables; these are used in interop.
            if ((m_mskPin == 0) || (m_misoPin == 0) || (m_mosiPin == 0)) { }
        ...
        {
            // FUTURE: This should be return "Task<SpiDevice*>
            return s_busInfo;
        }
