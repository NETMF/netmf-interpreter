...
namespace TestAlljoyn
{
    public class Program
    {
        ...
        public static void Main()
        {
            ...
            myAlljoyn.RegisterObjectsInterface(new AJ_Object() { path = ServicePath, interfaces = testInterface }, true);
            ...
            while (true)
            {
                if (!connected)
                {
                    ...
                    status = myAlljoyn.StartService(bus, DaemonServiceName, CONNECT_TIMEOUT, AJ.AJ_FALSE, ServicePort, ServiceName, AJ.AJ_NAME_REQ_DO_NOT_QUEUE, arg);
